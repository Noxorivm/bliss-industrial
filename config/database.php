...
// Tablas de respuestas específicas
define('DB_TABLE_AUDITORIA_RESP_CALIDAD', 'auditoria_resp_calidad');
define('DB_TABLE_AUDITORIA_RESP_GLOBAL', 'auditoria_resp_global');
...
define('DB_TABLE_AUDITORIA_RESP_ID', 'auditoria_resp_id');
...
if (!defined('RECAPTCHA_SECRET_KEY')) {
    define('RECAPTCHA_SECRET_KEY', '6Lfl_jcrAAAAAKIimDKPMcoGEZvxQKsLCX611Q4N');
}
